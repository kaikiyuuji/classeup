    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Visualize e gerencie todas as matrículas</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        <div class="border-b border-gray-200 px-6 py-4">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Matrículas</h1>
                    <p class="text-gray-600 mt-1">Gerencie as matrículas dos alunos</p>
                </div>
                <a href="{{ route('matriculas.create') }}" 
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-2">
                                    <a href="{{ route('matriculas.show', $matricula) }}" 
                                       class="text-blue-600 hover:text-blue-900 p-1" title="Visualizar">
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="text-gray-500">
                                    ...
                                    <p class="text-sm">Comece criando uma nova matrícula</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
