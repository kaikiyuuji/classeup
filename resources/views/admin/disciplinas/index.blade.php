                            ...
                            @foreach($disciplinas as $disciplina)
                                <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                @if($disciplina->descricao)
                                                    <p class="text-xs text-gray-400 mt-1">
                                                        {{ Str::limit($disciplina->descricao, 60) }}
                                                    </p>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="mt-4 flex justify-end space-x-2">
                                        ...
                                        <a href="{{ route('disciplinas.edit', $disciplina) }}" 
                                           class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded text-white bg-indigo-600 hover:bg-indigo-700 transition-colors duration-200">
                                            Editar
                                        </a>
                                        <form action="{{ route('disciplinas.destroy', $disciplina) }}" method="POST" class="inline-block">
                                            @csrf
