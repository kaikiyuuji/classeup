            ...
            <div class="px-8 py-6 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex gap-3">
                        <a href="{{ route('admin.chamadas.relatorio-aluno') }}" 
                           class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors shadow-sm font-medium">
                            <x-heroicon-o-chart-bar class="w-5 h-5 mr-2" />Ver Relatórios
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8">
                <div class="mb-8">
                    <h2 class="text-xl font-semibold text-gray-900 mb-6 flex items-center">
                        <x-heroicon-o-clipboard class="w-6 h-6 mr-3 text-blue-600" />
                    ...
                    @if($turmasComVinculo->isEmpty())
                        <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                            <div class="flex items-center">
                                <x-heroicon-o-exclamation-triangle class="w-6 h-6 text-yellow-500 mr-4" />
                                <div>
                                        ...
                                        @foreach($vinculos as $vinculo)
                                            <div class="flex justify-between items-center bg-white rounded-lg p-4 border border-gray-200 hover:border-blue-300 transition-colors">
                                                ...
                                                <div class="flex gap-2">
                                                    <a href="{{ route('admin.chamadas.chamada', ['turma' => $vinculo->turma_id, 'disciplina' => $vinculo->disciplina_id]) }}?professor_id={{ $vinculo->professor_id }}" 
                                                    ...
                                                    <a href="{{ route('admin.chamadas.gerenciar', ['turma' => $vinculo->turma_id, 'disciplina' => $vinculo->disciplina_id]) }}?professor_id={{ $vinculo->professor_id }}" 
